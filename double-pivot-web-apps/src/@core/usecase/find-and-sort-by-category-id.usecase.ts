...
export class FindAndSortByCategoryIdUseCase implements UseCase<CategoryDetailsParams, HttpResponseEntity<Posts[]>> {

  constructor(protected postsRepository: PostsRepository) { }

  execute(params: CategoryDetailsParams): Observable<HttpResponseEntity<Posts[]>> {
    return this.postsRepository.findAndSortByCategoryId(params);
  }
